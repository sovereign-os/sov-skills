---
name: technical-report-mastery
description: Advanced standard for creating elite-level technical reports, security assessments, and executive summaries.
version: 1.0.0
author: Sovereign OS Agent
tags: [documentation, reporting, owasp, executive-summary, compliance]
---
...
- **NO PERSONAS**: Reports must be authored using professional names (e.g., "Putera Kahfi"), never "Antigravity Oracle" or "Sovereign Soul".

### Rule 2: Multi-Perspective Reporting
Every major delivery MUST have three levels of documentation (as sections in the unified report):
1.  **Executive Brief**: High-level value and status (For PM/CEO).
2.  **Technical Implementation**: Technical deep-dive and code changes (For Devs).
3.  **Security & Impact**: OWASP mapping and performance (For QA/Security).

### Rule 3: Visual & Structural Excellence
...
3.  **Export**: Use the Sovereign Neural CLI `npm run sov document:export` for the final PDF.
