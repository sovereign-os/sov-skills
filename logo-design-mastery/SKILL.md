---
name: logo-design-mastery
description: High-end Architectural Logo Design System. Focuses on Sophisticated Corporate Modernism, Mathematical Symmetry, and Optical Perfection.
version: 2.0.0
author: Sovereign OS Agent
tags: [branding, logo, premium-design, architecture, minimalism]
---
...
| :------------ | :---------------------------- | :--------------------------------------------------------------------------------- |
| **Simple**    | Basic shapes (Circle/Square). | **Refined Minimalism**: Optical balance, strategic negative space.                 |
| **Modular**   | Blocks/Grid patterns.         | **Architectural Silhouette**: Interlocking components with varying visual weights. |
...
- **Action**: Adjust spacing for visual comfort. Avoid "clunky" geometry. Elements should feel like they "click" into place.

### 3.2 Negative Space Paradox

- **Rule**: The symbol should be formed by the absence of mass.
- **Action**: Use boolean subtraction to create "Invisible" shapes. The "S" shouldn't be drawn; it should be _revealed_ by the surrounding geometry.

### 3.3 The "Monochrome Majesty"

- **Strict Rule**: No colors until the form is perfect.
- **Texture**: 100% Vector. No gradients. No shadows. No "noise".

### 3.4 Stroke & Weight Harmony
...
3.  **Synthesis (The Pro Prompt)**:
    - **Subject**: Architectural Minimalist Logo for [Brand Name].
